...
public class ShopScrollList : MonoBehaviour
{
    ...
    public void Setup(EventCallback _callback, string _mode)
    {
        ...
        //add item
        ShopScrollItem item1 = new ShopScrollItem(); item1.uid = 1; item1.itemName = "test1"; item1.price = 100;
        itemList.Add(item1);
        ShopScrollItem item2 = new ShopScrollItem(); item2.uid = 2; item2.itemName = "test2"; item2.price = 200;
        itemList.Add(item2);
