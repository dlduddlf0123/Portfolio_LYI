...
public class CameraController : MonoBehaviour {
	...
	public float		fDistance = 5.0f;
	public float		fPitch = 5.0f;
	public float		fYaw = 0.0f;
	
	float				fDistance_cur;
	public float 		fSmoothTime = 0.1F;	// smooth, smaller is faster.
	...
	float minimumX = -360F;
	float maximumX = 360F;
	float minimumY = -60F; //fPitch
    float maximumY = 60F;
	float minimumZ = 1F; //fDistance
    float maximumZ = 10F;
