...
public class Zino : Character
{
    public bool isGrabbable = false;

    protected override void DoAwake()
    {
        characterColor = new Color32(77, 140, 255, 255);
    ...
    //    for (int i = 0; i < 4; i++)
    //    {
    //        arr_feet[i].footSound = gameMgr.b_sound.LoadAsset<AudioClip>(ReadOnly.Defines.SOUND_SFX_WALK01);
    //    }
    //}
