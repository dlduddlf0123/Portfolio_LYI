...
public class HeaderCanvas : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        dialogText.transform.rotation = Quaternion.LookRotation(dialogText.transform.position - gameMgr.mainCamera.transform.position);
    ...
    public void ShowCutsceneText(List<List<object>> __list, int _state, int _index)
    {
        ...
        dialogText = gameMgr.csvMgr.SetText(__list[_state], dialogText, _index); //@ 띄어쓰기변환
