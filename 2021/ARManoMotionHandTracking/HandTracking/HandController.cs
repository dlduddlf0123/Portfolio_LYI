...
public class HandController : MonoBehaviour
{
    ...
    GameManager gameMgr;
    public ManoHandMove manoHandMove;
    ...
    public void ToggleHandIcon(bool _isActive)
    {
       ...
       // handFollower.GetComponent<MeshRenderer>().enabled = toggleHandIcon;
        manoHandMove.arr_handFollwer[0].GetComponent<TrailRenderer>().enabled = toggleHandIcon;
    }
    ...
    public void ToggleHandOcclusion(bool _isActive)
    {
        ...
        if (_isActive)
        {
            gameMgr.arMainCamera.GetComponent<AROcclusionManager>().requestedHumanDepthMode = HumanSegmentationDepthMode.Best;
            gameMgr.arMainCamera.GetComponent<AROcclusionManager>().requestedHumanStencilMode = HumanSegmentationStencilMode.Best;
        }
        else
        {
            gameMgr.arMainCamera.GetComponent<AROcclusionManager>().requestedHumanDepthMode = HumanSegmentationDepthMode.Disabled;
            gameMgr.arMainCamera.GetComponent<AROcclusionManager>().requestedHumanStencilMode = HumanSegmentationStencilMode.Disabled;
        }
