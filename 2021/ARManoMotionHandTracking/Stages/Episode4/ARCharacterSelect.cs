...
public class ARCharacterSelect : ARObjectSelect
{
    ...
    public void CheckSuccess()
    {
        ...
        {
            gameMgr.currentEpisode.currentStage.arr_header[0].Success("맞았어!");
            gameMgr.currentEpisode.currentStage.arr_header[0].StartCoroutine(gameMgr.LateFunc(() => EndInteraction(), waitTime));
        }
        else
        {
            gameMgr.currentEpisode.currentStage.arr_header[0].Failure("아니야!");
