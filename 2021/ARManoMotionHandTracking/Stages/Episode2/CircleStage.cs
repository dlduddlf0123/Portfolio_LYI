...
public class CircleStage : StageManager
{
    protected override void DoAwake()
    {
        ...
        stageTitle = "Episode02";
        stageSubTitle = "Circle Land";

    }

    public override void SetInteractionPos()
    {
              ...
              && currentTimeline < list_endPos.Count)
        {
            ...
            {
                arr_header[i].transform.position = list_endPos[currentTimeline].GetChild(i).position;
                arr_header[i].transform.rotation = list_endPos[currentTimeline].GetChild(i).rotation;
