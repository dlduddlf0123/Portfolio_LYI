...
public class MiniGameDefense : MiniGameManager
{
    ...
    {
        typeMiniGame = MiniGameType.DEFENSE;
    ...
    public override void GameOver()
    {
        ...
        if (gameScore > PlayerPrefs.GetInt("DefenseHighScore", 0))
        {
            PlayerPrefs.SetInt("DefenseHighScore", gameScore);
