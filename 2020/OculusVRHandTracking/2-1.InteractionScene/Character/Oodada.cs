...
public class Oodada : Character
{
    ...
    protected override void Start()
    {
        ...
        list___dialog_kor.Add(gameMgr.dialogMgr.ReadDialogDatas(Defines.DIALOG_OODADA_KOR));
    ...
    protected override void StatusInit()
    {
        ...
        Status.likeFood = FoodType.FRUIT;
