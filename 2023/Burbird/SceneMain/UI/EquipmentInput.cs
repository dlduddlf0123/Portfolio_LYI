...
namespace Burbird
{
    public class EquipmentInput : MonoBehaviour, MMEventListener<MMInventoryEvent>
    {
        UIEquip ui_equip;
        ...
        public BurbirdEquip currentBurbirdEquip { get; set; }
